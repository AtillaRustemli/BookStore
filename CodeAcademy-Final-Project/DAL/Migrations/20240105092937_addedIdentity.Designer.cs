...
namespace CodeAcademy_Final_Project.DAL.Migrations
{
    ...
    [Migration("20240105092937_addedIdentity")]
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.ABook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 5, 13, 29, 36, 419, DateTimeKind.Local).AddTicks(1143),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 5, 13, 29, 36, 419, DateTimeKind.Local).AddTicks(2233),
                            SellCount = 0L,
                            Width = 15.1
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.EBook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 5, 13, 29, 36, 419, DateTimeKind.Local).AddTicks(3099),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2024, 1, 5, 13, 29, 36, 419, DateTimeKind.Local).AddTicks(3699),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "12f078c2-074c-4e9e-b5a8-cb0a3bc237a8",
                            ConcurrencyStamp = "cbb5e1a4-1cca-441b-91b5-4f9e88e69c72",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "0788f483-2b6a-4da2-be09-72380234f457",
                            ConcurrencyStamp = "3de8299e-1721-4314-9286-1723782968e8",
                            Name = "SuperAdmin",
                            NormalizedName = "SUPERADMIN"
                        },
                        new
                        {
                            Id = "d519da1b-b6ae-4bbe-83dc-4d7522661644",
                            ConcurrencyStamp = "7f45b705-6c31-4a89-9f69-ad9cf0dc164c",
                            Name = "Member",
