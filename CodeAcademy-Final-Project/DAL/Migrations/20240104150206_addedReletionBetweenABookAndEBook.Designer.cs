...
namespace CodeAcademy_Final_Project.DAL.Migrations
{
    ...
    [Migration("20240104150206_addedReletionBetweenABookAndEBook")]
    partial class addedReletionBetweenABookAndEBook
    {
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.ABook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 4, 19, 2, 5, 991, DateTimeKind.Local).AddTicks(3528),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 4, 19, 2, 5, 991, DateTimeKind.Local).AddTicks(4867),
                            SellCount = 0L,
                            Width = 15.1
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.EBook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 4, 19, 2, 5, 991, DateTimeKind.Local).AddTicks(6040),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2024, 1, 4, 19, 2, 5, 991, DateTimeKind.Local).AddTicks(6589),
