...
namespace CodeAcademy_Final_Project.DAL.Migrations
{
    ...
    [Migration("20240104130826_changedSeedData")]
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.ABook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 4, 17, 8, 25, 808, DateTimeKind.Local).AddTicks(2135),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 4, 17, 8, 25, 808, DateTimeKind.Local).AddTicks(3119),
                            SellCount = 0L,
                            Width = 15.1
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.EBook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 4, 17, 8, 25, 808, DateTimeKind.Local).AddTicks(3973),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2024, 1, 4, 17, 8, 25, 808, DateTimeKind.Local).AddTicks(4498),
