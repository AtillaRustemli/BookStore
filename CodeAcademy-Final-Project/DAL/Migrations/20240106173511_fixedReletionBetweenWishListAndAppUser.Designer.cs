...
namespace CodeAcademy_Final_Project.DAL.Migrations
{
    ...
    [Migration("20240106173511_fixedReletionBetweenWishListAndAppUser")]
    partial class fixedReletionBetweenWishListAndAppUser
    {
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.ABook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 6, 21, 35, 10, 812, DateTimeKind.Local).AddTicks(1075),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 6, 21, 35, 10, 812, DateTimeKind.Local).AddTicks(2016),
                            SellCount = 0L,
                            Width = 15.1
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.EBook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 11.0,
                            PromotionId = 1,
                            Released = new DateTime(2024, 1, 6, 21, 35, 10, 812, DateTimeKind.Local).AddTicks(2799),
                            SellCount = 0L
                        });
                });
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2024, 1, 6, 21, 35, 10, 812, DateTimeKind.Local).AddTicks(3347),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "e6d9ff74-5c41-458b-9061-176e99568d3a",
                            ConcurrencyStamp = "442f12ce-cfed-4014-8311-0fb824f52d37",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "05ad565a-bf4e-493b-9b53-8ea505015a4f",
                            ConcurrencyStamp = "b8bf0968-43a8-4d67-b7db-01d3aa7d5f90",
                            Name = "SuperAdmin",
                            NormalizedName = "SUPERADMIN"
                        },
                        new
                        {
                            Id = "7a56adc8-45b1-4f1f-8a2c-6c41c8a1d139",
                            ConcurrencyStamp = "5352d1b8-673b-4d99-bf77-c5ecf9dbc964",
                            Name = "Member",
