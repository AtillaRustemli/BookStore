...
namespace CodeAcademy_Final_Project.DAL.Migrations
{
    ...
    [Migration("20231223173938_addedSocialMediaTableAndItsConfiguration")]
    partial class addedSocialMediaTableAndItsConfiguration
    {
            ...
            modelBuilder.Entity("CodeAcademy_Final_Project.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 1.0,
                            PromotionId = 1,
                            Released = new DateTime(2023, 12, 23, 21, 39, 37, 839, DateTimeKind.Local).AddTicks(7848)
                        });
                });
